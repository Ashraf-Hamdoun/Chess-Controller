...
void main() {
  ...
  group('Get/Put/Remove', () {
    ...
    final positions = <Map<String, dynamic>>[
      {
        'pieces': {
          'a7': Piece(PieceType.PAWN, Color.WHITE),
          'b7': Piece(PieceType.PAWN, Color.BLACK),
          'c7': Piece(KNIGHT, Color.WHITE),
          'd7': Piece(KNIGHT, Color.BLACK),
          'e7': Piece(PieceType.BISHOP, Color.WHITE),
          'f7': Piece(PieceType.BISHOP, Color.BLACK),
          'g7': Piece(PieceType.ROOK, Color.WHITE),
          'h7': Piece(PieceType.ROOK, Color.BLACK),
          'a6': Piece(PieceType.QUEEN, Color.WHITE),
          'b6': Piece(PieceType.QUEEN, Color.BLACK),
          'a4': Piece(PieceType.KING, Color.WHITE),
          'h4': Piece(PieceType.KING, Color.BLACK)
        },
        'should_pass': true
      },
      {
        'pieces': {'j4': Piece(PieceType.PAWN, Color.WHITE)}, // bad square
        'should_pass': false
      },
    ];
  ...
  group('Piece Name', () {
    test('should return correct name for white pawn', () {
      final piece = Piece(PieceType.PAWN, Color.WHITE);
      expect(piece.name, equals('white_pawn'));
    });

    test('should return correct name for black king', () {
      final piece = Piece(PieceType.KING, Color.BLACK);
      expect(piece.name, equals('black_king'));
    });

    test('should return correct name for white queen', () {
      final piece = Piece(PieceType.QUEEN, Color.WHITE);
      expect(piece.name, equals('white_queen'));
    });
  });
}
